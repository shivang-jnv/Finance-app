...
import { calculatePercentageChange, fillMissingDays, convertAmountFromMilliunits } from "@/lib/utils";
import { differenceInDays, parse, subDays } from "date-fns";
import { and, desc, eq, gte, lt, lte, sql, sum } from "drizzle-orm";

export const getSummary = async (userId: string, from?: string, to?: string, accountId?: string) => {
  ...
  return {
    remainingAmount: convertAmountFromMilliunits(currentPeriod.remaining),
    remainingChange: remainingChange,
    incomeAmount: convertAmountFromMilliunits(currentPeriod.income),
    incomeChange: incomeChange,
    expensesAmount: convertAmountFromMilliunits(currentPeriod.expenses),
